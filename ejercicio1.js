class Persona {
  ...
  let contrayente1 = new Persona('Juan', 'Pérez', 30, 'Masculino', 'Calle 6 #45-09');
  let contrayente2 = new Persona('María', 'Gómez', 28, 'Femenino', 'Cra 10 #45-09');
  let testigo1 = new Persona('Pedro', 'López', 35, 'Masculino', 'Calle 45 # 46-5');
  let testigo2 = new Persona('Ana', 'Martínez', 32, 'Femenino', 'Calle 5 #46-5');
