...
class Vuelo {
    ...
    reservarBillete(pasajero, asiento) {
        if (this.billetes.length < this.plazas) {
            let numeroBillete = `${this.billetes.length + 1}`;
...
let pasajero1 = new Pasajero("Juan", "Perez", 30);
let avion1 = new Avion("ABC123", 150);


let fechaEstatica = new Date('2024-12-01T12:00:00');
let vuelo1 = new Vuelo("V001", fechaEstatica, 100, avion1);
