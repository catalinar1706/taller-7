...
let paciente = new Paciente("12345", "Ana Gomez", "Calle 9 # 12-09");
let medico = new Medico("001", "Doctor. Perez", "Cardiologia");
let enfermero1 = new Enfermero("101", "Luis Fernandez");
let enfermero2 = new Enfermero("102", "Maria Lopez");
let analisis = new Analisis("A001", "Sangre", new Date(), "Todo bien", medico, [enfermero1, enfermero2]);  // Muestra la fecha y hora actuales
